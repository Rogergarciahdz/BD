...
-- Schema tagtalentdb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `tagtalentdb` DEFAULT CHARACTER SET utf8 ;
USE `tagtalentdb` ;

-- -----------------------------------------------------
-- Table `tagtalentdb`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tagtalentdb`.`usuario` (
...
-- -----------------------------------------------------
-- Table `tagtalentdb`.`categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tagtalentdb`.`categoria` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tagtalentdb`.`publicacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tagtalentdb`.`publicacion` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tagtalentdb`.`reacciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tagtalentdb`.`reacciones` (
  `usuario_id` INT NOT NULL,
